...
global_xl_reconfigure(xlator_t *this, dict_t *options)
{
    ...
    getctx(this)->measure_latency = bool_opt;

    GF_OPTION_RECONF("metrics-dump-path", getctx(this)->config.metrics_dumppath,
                     options, str, out);
...
global_xl_init(xlator_t *this)
{
    ...
    GF_OPTION_INIT("metrics-dump-path", getctx(this)->config.metrics_dumppath, str,
                   out);
