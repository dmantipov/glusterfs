...
dht_check_and_open_fd_on_subvol(xlator_t *this, call_frame_t *frame)
{
    ...
    */
    ...
    ret = synctask_new(getctx(this)->env, dht_check_and_open_fd_on_subvol_task,
...
dht_rebalance_complete_check(xlator_t *this, call_frame_t *frame)
{
    ...
    ret = synctask_new(getctx(this)->env, dht_migration_complete_check_task,
...
dht_rebalance_in_progress_check(xlator_t *this, call_frame_t *frame)
{
    ...
    ret = synctask_new(getctx(this)->env, dht_rebalance_inprogress_task,
